...
function SelectContent({
  ...
  Pick<
    ...
    | "positionMethod"
  > & {
    /** 在 React Flow 等带 transform 的容器内使用：浮层不挂到 body，避免下拉错位 */
    disablePortal?: boolean
    /** 自定义 Portal 挂载节点（默认 document.body） */
    portalContainer?: HTMLElement | React.RefObject<HTMLElement | null> | null
  }) {
  const resolvedPositionMethod =
    positionMethod ?? (disablePortal ? ("absolute" as const) : undefined)
